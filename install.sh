...
main() {
  printf "\n${BOLD}f00tils${RESET} ${DIM}installer · binary f00 · 0.16.10 multicall${RESET}\n" >&2
  ...
  printf "${DIM}knobs: F00_TOOLS=all|ls,cat,find,…  F00_SUPERSEDE=0  F00_LOCAL=asm  F00_VERSION=v0.16.10${RESET}\n" >&2
