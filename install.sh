...
#   F00_VERSION      release tag (default: latest; default: latest / v0.15.15)
...
main() {
  printf "\n${BOLD}f00tils${RESET} ${DIM}installer · binary f00 · 0.15.15 multicall${RESET}\n" >&2
  ...
  printf "${DIM}knobs: F00_TOOLS=all|ls,cat,…  F00_SUPERSEDE=0  F00_LOCAL=asm  F00_VERSION=v0.15.15${RESET}\n" >&2
