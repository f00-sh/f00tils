...
**Overall: 2.4× faster than GNU coreutils** (142% faster overall; geometric mean of 91 timed tools · 90 wins · median 2.36×).
<!-- bench-headline:end -->
...
<!-- bench-table:start -->
_CI / suite bench · `2026-07-24T15:00:15Z` · N=15 median · x86_64 · Linux 6.17.0-1020-azure_

| Tool | Command | GNU | f00 `--core` | vs GNU |
|------|---------|-----|--------------|--------|
| `true` | `f00-true --core` | 0.54 ms | **0.26 ms** | **~2.1×** |
| `basename` | `f00-basename --core /usr/bin/ls` | 0.77 ms | **0.26 ms** | **~2.9×** |
| `nproc` | `f00-nproc --core` | 0.82 ms | **0.27 ms** | **~3.1×** |
| `whoami` | `f00-whoami --core` | 0.91 ms | **0.32 ms** | **~2.8×** |
| `cat` | `f00-cat --core fixture.txt` | 0.83 ms | **0.29 ms** | **~2.8×** |
| `wc` | `f00-wc --core -l fixture.txt` | 0.82 ms | **0.36 ms** | **~2.3×** |
| `md5sum` | `f00-md5sum --core fixture.txt` | 1.21 ms | **0.41 ms** | **~3.0×** |
| `sha256sum` | `f00-sha256sum --core fixture.txt` | 1.18 ms | **0.46 ms** | **~2.6×** |
| `sort` | `f00-sort --core fixture.txt` | 1.32 ms | **0.79 ms** | **~1.7×** |
