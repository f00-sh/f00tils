...
**Overall: 2.4× faster than GNU coreutils** (144% faster overall; geometric mean of 91 timed tools · 90 wins · median 2.4×).
<!-- bench-headline:end -->
...
<!-- bench-table:start -->
_CI / suite bench · `2026-07-24T15:59:17Z` · N=15 median · x86_64 · Linux 6.17.0-1020-azure_

| Tool | Command | GNU | f00 `--core` | vs GNU |
|------|---------|-----|--------------|--------|
| `true` | `f00-true --core` | 0.58 ms | **0.26 ms** | **~2.2×** |
| `basename` | `f00-basename --core /usr/bin/ls` | 0.84 ms | **0.27 ms** | **~3.1×** |
| `nproc` | `f00-nproc --core` | 0.80 ms | **0.27 ms** | **~3.0×** |
| `whoami` | `f00-whoami --core` | 0.86 ms | **0.28 ms** | **~3.0×** |
...
| `sort` | `f00-sort --core fixture.txt` | 1.30 ms | **0.75 ms** | **~1.7×** |
| `ls` | `f00-ls --core -1 dir` | 1.01 ms | **0.45 ms** | **~2.3×** |
<!-- bench-table:end -->
