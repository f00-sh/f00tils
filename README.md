...
<!-- bench-table:start -->
_CI / suite bench · `2026-07-27T18:01:11Z` · N=15 median · x86_64 · Linux 6.17.0-1020-azure_ · **totals are per package set, not blended**

| Package | Tool | Command | GNU wall | f00 wall | Speed | CPU × |
|---------|------|---------|---------:|---------:|------:|------:|
| coreutils | `true` | `f00-true --core` | 0.54 ms | **0.26 ms** | **~2.0×** | **~2.3×** |
| coreutils | `basename` | `f00-basename --core /usr/bin/ls` | 0.76 ms | **0.26 ms** | **~2.9×** | **~3.5×** |
| coreutils | `nproc` | `f00-nproc --core` | 0.78 ms | **0.27 ms** | **~2.9×** | **~3.5×** |
| coreutils | `whoami` | `f00-whoami --core` | 0.85 ms | **0.27 ms** | **~3.2×** | **~3.8×** |
| coreutils | `cat` | `f00-cat --core fixture.txt` | 0.81 ms | **0.31 ms** | **~2.6×** | **~3.1×** |
| coreutils | `wc` | `f00-wc --core -l fixture.txt` | 0.81 ms | **0.36 ms** | **~2.2×** | **~2.5×** |
| coreutils | `md5sum` | `f00-md5sum --core fixture.txt` | 1.17 ms | **0.39 ms** | **~3.0×** | **~3.3×** |
| coreutils | `sha256sum` | `f00-sha256sum --core fixture.txt` | 1.17 ms | **0.45 ms** | **~2.6×** | **~2.8×** |
| coreutils | `sort` | `f00-sort --core fixture.txt` | 1.29 ms | **0.95 ms** | **~1.4×** | **~1.4×** |
| coreutils | `ls` | `f00-ls --core -1 dir` | 0.99 ms | **0.44 ms** | **~2.3×** | **~2.5×** |
| grep | `grep` | `f00-grep --core -F hello fixture.txt` | 1.03 ms | **0.42 ms** | **~2.5×** | **~2.8×** |
| findutils | `find` | `f00-find --core -maxdepth 1 -name '*.txt' /tmp/f00-suite-bench.nytl5for/dir` | 1.06 ms | **0.46 ms** | **~2.3×** | **~2.5×** |
| diffutils | `diff` | `f00-diff --core -u a.txt b.txt` | 0.92 ms | **0.51 ms** | **~1.8×** | **~1.9×** |
| diffutils | `cmp` | `f00-cmp --core fixture.txt fixture.txt` | 0.87 ms | **0.41 ms** | **~2.1×** | **~2.3×** |
<!-- bench-table:end -->

<!-- bench-headline:start -->
**GNU coreutils:** wall 2.4× · CPU 2.6× (91/91 wall wins · 91/91 CPU wins) · **GNU grep:** wall 2.9× · CPU 3.1× (3/3 wall wins · 3/3 CPU wins) · **GNU findutils:** wall 3.6× · CPU 4.1× (2/2 wall wins · 2/2 CPU wins) · **GNU diffutils:** wall 2.7× · CPU 2.9× (4/4 wall wins · 4/4 CPU wins)
<!-- bench-headline:end -->
