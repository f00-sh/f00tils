...
help_msg:
    ...
    db 10
    db "Default is modern mode (color, Nerd File Icons, table columns, git).", 10
    ...
    db "      --icons[=STYLE]        icons: auto|nerd|emoji|glyph|ascii|never", 10
    db "                             (modern auto=nerd File Icons on color TTY; off under --core)", 10
...
util_table:
    ...
    dq name_grep, grep_main, name_f00_grep, grep_main
    dq name_egrep, egrep_main, name_f00_egrep, egrep_main
    dq name_fgrep, fgrep_main, name_f00_fgrep, fgrep_main
    dq name_find, find_main, name_f00_find, find_main
